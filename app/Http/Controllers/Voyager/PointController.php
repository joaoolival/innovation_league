...
class PointController extends VoyagerBaseController
{
    ...
    // POST BR(E)AD
    public function update($request, $points)
    {
        $data = $this->objPoints->where(['id_game' => $points['id_game']])->where(['id_team' => $points['id_team']])->update([
     ...
     */
    public function store($points)
    {
        $data = $this->objPoints->create([
          'id_game'=>$points['id_game'],
          'id_team'=>$points['id_team'],
          'points'=>$points['points'],
        ]);
