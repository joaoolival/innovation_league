...
class GameController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $id_team_home = $request->id_team_home;
        $id_team_away = $request->id_team_away;
        $goals_home = $request->goals_home;
        $goals_away = $request->goals_away;
        $id_type = $request->id_type;
        $id_group = $request->id_group;


        $data = $this->objGame->where(['id' => $id])->update([
        ...
        if($id_type == 1){
          if($goals_home > $goals_away){
            $pointsHome = ['id_game' => $id, 'id_team' => $id_team_home, 'points' => 3];
            $pointsAway = ['id_game' => $id, 'id_team' => $id_team_away, 'points' => 0];
          }elseif ($goals_home == $goals_away) {
            $pointsHome = ['id_game' => $id, 'id_team' => $id_team_home, 'points' => 1];
            $pointsAway = ['id_game' => $id, 'id_team' => $id_team_away, 'points' => 1];
          } else {
            $pointsHome = ['id_game' => $id, 'id_team' => $id_team_home, 'points' => 0];
            $pointsAway = ['id_game' => $id, 'id_team' => $id_team_away, 'points' => 3];
          }



          $this->pointController->update($request, $pointsHome);
          $this->pointController->update($request, $pointsAway);
        }
    ...
    public function store(Request $request)
    {
        ...
        if($id_type == 1){
          if($goals_home > $goals_away){
            $pointsHome = ['id_game'=>$data->id, 'id_team' => $id_team_home, 'points' => 3];
            $pointsAway = ['id_game'=>$data->id, 'id_team' => $id_team_away, 'points' => 0];
          }elseif ($goals_home == $goals_away) {
            $pointsHome = ['id_game'=>$data->id, 'id_team' => $id_team_home, 'points' => 1];
            $pointsAway = ['id_game'=>$data->id, 'id_team' => $id_team_away, 'points' => 1];
          } else {
            $pointsHome = ['id_game'=>$data->id, 'id_team' => $id_team_home, 'points' => 0];
            $pointsAway = ['id_game'=>$data->id, 'id_team' => $id_team_away, 'points' => 3];
          }


          $this->pointController->store($pointsHome);
          $this->pointController->store($pointsAway);
        }
